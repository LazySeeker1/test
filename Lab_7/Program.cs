...
/*
 * 23Зчитати число з клавіатури та записати його в ліст, розбивши по
 * порядку на на цифри. В отриманому лісті порахувати кількість повторень
 * кожної цифри. Перевірити чи серед цих чисел є задане.
 */
